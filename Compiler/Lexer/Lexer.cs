...
namespace Compiler.Lexer
{
    ...
    {
        private static readonly string[] _Keywords = { "let", "with", "type", "alias", "data", "choice" };
        ...
        private Token ScanAnnotation()
        {
            ...
            return CreateToken(TokenKind.Annotation);
        }
        ...
        private Token ScanEndBlock()
        {
            Consume();

            DoEndBlock();

            return CreateToken(TokenKind.EndBlock);
        }
        

        private Token ScanTab()
        {
            Consume();

            DoTab();

            return CreateToken(TokenKind.Indent);
        }
